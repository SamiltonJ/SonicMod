...
namespace Sonic.Modules.Survivors
{
    internal class SonicSurvivor : SurvivorBase
    {
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            bodyNameToken = SonicMod.developerPrefix + "_HENRY_BODY_NAME",
            ...
            jumpCount = 1,
            maxHealth = 110f,
            subtitleNameToken = SonicMod.developerPrefix + "_HENRY_BODY_SUBTITLE",
        ...
        internal override void InitializeSkills()
        {
            ...
            string prefix = SonicMod.developerPrefix;
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(SonicMod.developerPrefix + "_HENRY_BODY_DEFAULT_SKIN_NAME",
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(SonicMod.developerPrefix + "_HENRY_BODY_MASTERY_SKIN_NAME",
