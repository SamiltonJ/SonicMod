...
namespace Sonic.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = SonicMod.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = SonicMod.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = SonicMod.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = SonicMod.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            SonicMod.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            SonicMod.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            SonicMod.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
